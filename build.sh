...
mkdir -p ambari-agent/target/ambari-agent-2.1.1.0/ambari_agent
mkdir -p ambari-client/python-client/target/python-client-2.1.1.0/ambari_client
mkdir -p ambari-shell/ambari-python-shell/target/ambari-python-shell-2.1.1.0/ambari_shell
