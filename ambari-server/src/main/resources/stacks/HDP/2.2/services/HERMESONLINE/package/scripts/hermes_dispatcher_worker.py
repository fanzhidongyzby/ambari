...
SERVICE_NAME = "HermesDispatcherWorker"


class HermesDispatcherWorker(Script):
    ...
    def configure(self, env):
        ...
        util.load_command_script(env, 'start_dispatcher.sh', 'start_dispatcher.sh.j2')
...
if __name__ == "__main__":
    HermesDispatcherWorker().execute()
