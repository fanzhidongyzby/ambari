...
CREATE TABLE tdw_group_location (
    group_name character varying not null, 
...
ALTER TABLE public.tdw_group_location OWNER TO tdwmeta;
...
--
-- Name: tdw_group_location_group_name_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tdwmeta
--

ALTER TABLE ONLY tdw_group_location
    ADD CONSTRAINT tdw_group_location_group_name_fkey FOREIGN KEY (group_name) REFERENCES tdwrole(role_name) ON DELETE CASCADE;


--
-- Name: tdw_group_location_create_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tdwmeta
--

ALTER TABLE ONLY tdw_group_location
    ADD CONSTRAINT tdw_group_location_create_user_fkey FOREIGN KEY (create_user) REFERENCES tdwuser(user_name) ON DELETE CASCADE;
    

--
-- Name: tdw_group_location_group_name_idx; Type: INDEX; Schema: public; Owner: tdwmeta; Tablespace: 
--

CREATE INDEX tdw_group_location_group_name_idx ON tdw_group_location USING btree (group_name);


--
-- Name: tdw_group_location_location_idx; Type: INDEX; Schema: public; Owner: tdwmeta; Tablespace: 
--

CREATE INDEX tdw_group_location_location_idx ON tdw_group_location USING btree (location);


--
-- Name: tdw_group_location_create_user_idx; Type: INDEX; Schema: public; Owner: tdwmeta; Tablespace: 
--

CREATE INDEX tdw_group_location_create_user_idx ON tdw_group_location USING btree (create_user);
