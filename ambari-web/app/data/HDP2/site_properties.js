...
var hdp2properties = [
 ...
 /**********************************************LHOTSE***************************************/
    ...
    },
	{
      ...
      "name": "root.path",
      "displayName": "根目录",
      "defaultDirectory": "/lhotse/ftp_data",
      "isReconfigurable": false,
      "displayType": "directory",
      "isOverridable": false,
      "isVisible": true,
...
/********************************************* KAFKA *****************************/
  ...
  },
  {
    "id": "site property",
    "name": "kafka_log_dir",
    "displayName": "kafka_log_dir",
    "value": "",
    "defaultValue": "",
    "defaultDirectory": "/var/log/kafka",
    "displayType": "directories",
    "serviceName": "KAFKA",
...
/********************************************* flume-agent *****************************/
  ...
  },
  {
    ...
    "defaultDirectory": "/var/log/flume",
    "isReconfigurable": false,
    "displayType": "directory",
    "isOverridable": false,
    "isVisible": true,
...
/**********************************************HDFS***************************************/
  ...
  },
  {
    ...
    "defaultDirectory": "/var/log/hadoop",
    "isReconfigurable": false,
    "displayType": "directory",
    "isOverridable": false,
    "isVisible": true,
...
/**********************************************MAPREDUCE2***************************************/
  ...
  },
  {
    ...
    "description": "",
    "defaultDirectory": "/var/log/hadoop-mapreduce",
    "displayType": "directory",
    "isOverridable": false,
    "isVisible": true,
    "isReconfigurable": false,
...
/**********************************************YARN***************************************/
  ...
  },
  {
    ...
    "description": "",
    "defaultDirectory": "/var/log/hadoop-yarn",
    "displayType": "directory",
    "isOverridable": false,
    "isReconfigurable": false,
    "isVisible": true,
...
/**********************************************HBASE***************************************/
  ...
  },
  {
    ...
    "defaultDirectory": "/var/log/hbase",
    "isReconfigurable": false,
    "displayType": "directory",
    "isOverridable": false,
    "isVisible": true,
...
/**********************************************HIVE***************************************/
  ...
  },
  {
    ...
    "defaultDirectory": "/var/log/webhcat",
    "isReconfigurable": false,
    "displayType": "directory",
    "isOverridable": false,
    "isVisible": true,
...
/**********************************************OOZIE***************************************/
  ...
  },
  {
    ...
    "defaultDirectory": "/var/log/oozie",
    "isReconfigurable": false,
    "displayType": "directory",
    "isOverridable": false,
    "isVisible": true,
...
/**********************************************ZOOKEEPER***************************************/
  ...
  },
  {
    ...
    "defaultDirectory": "/var/log/zookeeper",
    "isReconfigurable": false,
    "displayType": "directory",
    "isOverridable": false,
    "isVisible": true,
...
/**********************************************FALCON***************************************/
  ...
  },
  {
    ...
    "defaultDirectory": "/var/log/falcon",
    "displayType": "directory",
    "isOverridable": false,
    "isVisible": true,
    "isRequiredByAgent": true,
...
/**********************************************STORM***************************************/
  {
    ...
    "defaultDirectory": "/var/log/storm",
    "displayType": "directory",
    "isReconfigurable": true,
    "isVisible": true,
    "isRequiredByAgent": true,
...
/************************************************AMBARI_METRICS******************************************/
  ...
  },
  {
    ...
    "defaultDirectory": "/var/log/ambari-metrics-collector",
    "displayType": "directory",
    "serviceName": "AMBARI_METRICS",
  ...
  },
  {
    ...
    "defaultDirectory": "/var/log/ambari-metrics-monitor",
    "displayType": "directory",
    "serviceName": "AMBARI_METRICS",
    "filename": "ams-env.xml",
    "category": "General",
...
var atsProperties = [
  ...
  },
  {
    "id": "puppet var",
    "name": "hbase_log_dir",
    "displayName": "hbase_log_dir",
    "description": "The parent directory for Log Directories for HBase.",
    "defaultDirectory": "/var/log/ambari-metrics-collector",
    "isReconfigurable": false,
    "displayType": "directory",
    "isOverridable": false,
    ...
    "category": "Advanced ams-hbase-env"
  },
  {
    "id": "puppet var",
    "name": "redis_log_file",
    "displayName": "Redis Log File",
    "description": "The path for Redis log files.",
    "defaultDirectory": "/var/log/redis/redis.log",
    "isReconfigurable": false,
    "displayType": "directory",
    "isOverridable": false,
    "isVisible": true,
    "serviceName": "REDIS",
    "filename": "redis-env.xml",
    "category": "Advanced redis-env"
  },
  {
    "id": "puppet var",
    "name": "mysql.data.dir",
    "displayName": "Mysql Log File",
    "description": "The data log for mysql.",
    "defaultDirectory": "/dse/mysql_data",
    "isReconfigurable": false,
    "displayType": "directory",
    "isOverridable": false,
    "isVisible": true,
    "serviceName": "DSE",
    "filename": "db-properties.xml",
    "category": "Advanced db-properties"
  },
  {
    "id": "puppet var",
    "name": "nginx.log.path",
